    ...
    <div className="airspace_container">
      <div className='airspace_title_bar'>
        ...
        <div className='airspace_title_type'>
          <img src="/assets/banned.png" alt=""  width='auto' height='50px' />
        ...
        <div className='airspace_title_type'>
          <img src="/assets/landing.png" alt="" width='auto' height='50px'/>
          <div className='airspace_titlt_type_info'>
            <span>20</span>
            <span>迫降区</span>
          </div>
        ...
        <div className='airspace_title_type'>
          <img src="/assets/goback.png" alt="" width='auto' height='50px'/>
          <div className='airspace_titlt_type_info'>
            <span>23</span>
            <span>遣返区</span>
          </div>
      ...
      <div className='airspace_content_list'>
        {filterList.map((item, index) => (
          <div key={index} className='airspace_content_item'>
            ...
            <img src={`/assets/${item.bannedType==='遣返区域'?'goback':item.bannedType==='禁止区域'?'banned':'landing'}.png`} alt="" width='auto' height='50px' />
          </div>
        ))}
      </div>
    </div>
